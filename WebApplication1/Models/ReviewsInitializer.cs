...
namespace BookPortal.Models
{
	public class ReviewsInitializer : DropCreateDatabaseIfModelChanges<ReviewsContext>
	{
		protected override void Seed(ReviewsContext context)
		{
			...
			foreach (CategoriesDB item in categories)
			{
			...
			List<ReviewsDB> reviews = new List<ReviewsDB>()
			{
				...
				new ReviewsDB() { BookName="A Modern Instance" ,Confirmation=true, BookSubject="Subject is Modern Instance", AuthorName="Charlies Dickens", BookAnalysis="Mind blowing", OtherBooks="Annie Kilbum", ReviewType="Analysis", CategoryId=6, MainPage=true, Picture="modernınstance.jpg" , UploadDate=DateTime.Now.AddDays(-5), Content="In the novel, Howells uses the divorce theme to portray the widening cultural divisions in American society, and in this way, A Modern Instance anticipates many of Howells’s later novels in both its style and preoccupations. Old and new, rural and urban, life in the West and life in the East, and traditional orthodoxy and modern intellectual skepticism are compared in a series of contrasts which reveal Howells’s concern with the social and economic problems of his time. "},
				new ReviewsDB() { BookName="Hard Times" ,Confirmation=true, BookSubject="Subject is Hard Times", AuthorName="Amelia B.Edwards", BookAnalysis="Informative", OtherBooks="Children Blood and Bone", ReviewType="Analysis", CategoryId=2, MainPage=true, Picture="hardtimes.jpg" , UploadDate=DateTime.Now.AddDays(-2), Content="Having Sissy in Gradgrind's house worries Bounderby, who wants to marry teenage Louisa. He fears Sissy will corrupt Louisa, but he is mistaken. Sissy is kind and diligent, except when her father's disappearance overwhelms her. Then, she cannot help but cry. Noticing Sissy's tears one day, Louisa comforts her. Sissy and Louisa then become closer. While Sissy is often criticized at school for delighting in fancy rather than fact, Louisa has discovered she prefers imagination to reason. Nonetheless, when Bounderby, whom Louisa does not love, asks her to marry him, she agrees."},
				new ReviewsDB() { BookName="Pharaohs, Fellahs and Explorers" , Confirmation=true,BookSubject="Subject is Pharaohs", AuthorName="Jack ListedVersion", BookAnalysis="Strongly Recommended", OtherBooks="Adventure", ReviewType="Analysis", CategoryId=1, MainPage=true, Picture="pharaohs.jpg" , UploadDate=DateTime.Now.AddDays(-10), Content="The novel features a strong female heroine, Frona Welse. Frona was born into a wealthy family and educated at Stanford but she takes to the Yukon trail after upsetting her father and his wealthy community of friends with her out-spoken ways and her innocent friendship with the town's prostitute."},
				new ReviewsDB() { BookName="The End of Eternity" , Confirmation=true,BookSubject="Subject is end of the eternity", AuthorName="Charlies Dickens", BookAnalysis="Mind blowing", OtherBooks="Annie Kilbum", ReviewType="Analysis", CategoryId=2, MainPage=true, Picture="eternity.jpg" , UploadDate=DateTime.Now.AddDays(-5), Content="In the novel, Howells uses the divorce theme to portray the widening cultural divisions in American society, and in this way, A Modern Instance anticipates many of Howells’s later novels in both its style and preoccupations. Old and new, rural and urban, life in the West and life in the East, and traditional orthodoxy and modern intellectual skepticism are compared in a series of contrasts which reveal Howells’s concern with the social and economic problems of his time. "},
				new ReviewsDB() { BookName="Children of Bloood and Bone" ,Confirmation=true, BookSubject="Subject is children's life", AuthorName="Amelia B.Edwards", BookAnalysis="Informative", OtherBooks="Children Blood and Bone", ReviewType="Analysis", CategoryId=3, MainPage=true, Picture="blood.jpg" , UploadDate=DateTime.Now.AddDays(-2), Content="Having Sissy in Gradgrind's house worries Bounderby, who wants to marry teenage Louisa. He fears Sissy will corrupt Louisa, but he is mistaken. Sissy is kind and diligent, except when her father's disappearance overwhelms her. Then, she cannot help but cry. Noticing Sissy's tears one day, Louisa comforts her. Sissy and Louisa then become closer. While Sissy is often criticized at school for delighting in fancy rather than fact, Louisa has discovered she prefers imagination to reason. Nonetheless, when Bounderby, whom Louisa does not love, asks her to marry him, she agrees."},
				new ReviewsDB() { BookName="The Desert and the Snow" ,Confirmation=true, BookSubject="Subject is desert and the snow", AuthorName="Jack ListedVersion", BookAnalysis="Strongly Recommended", OtherBooks="Adventure", ReviewType="Analysis", CategoryId=6, MainPage=true, Picture="desertsnow.jpg" , UploadDate=DateTime.Now.AddDays(-10), Content="The novel features a strong female heroine, Frona Welse. Frona was born into a wealthy family and educated at Stanford but she takes to the Yukon trail after upsetting her father and his wealthy community of friends with her out-spoken ways and her innocent friendship with the town's prostitute."},
				new ReviewsDB() { BookName="The Cocoon: A Rest-Cure Comedy" ,Confirmation=true, BookSubject="Subject is cocoon", AuthorName="Charlies Dickens", BookAnalysis="Mind blowing", OtherBooks="Annie Kilbum", ReviewType="Analysis", CategoryId=6, MainPage=true, Picture="cocoon.jpg" , UploadDate=DateTime.Now.AddDays(-5), Content="In the novel, Howells uses the divorce theme to portray the widening cultural divisions in American society, and in this way, A Modern Instance anticipates many of Howells’s later novels in both its style and preoccupations. Old and new, rural and urban, life in the West and life in the East, and traditional orthodoxy and modern intellectual skepticism are compared in a series of contrasts which reveal Howells’s concern with the social and economic problems of his time. "},
				new ReviewsDB() { BookName="A Thousand Miles Up the Nile" , Confirmation=true, BookSubject="Subject is History of the Nile", AuthorName="Amelia B.Edwards", BookAnalysis="Informative", OtherBooks="Children Blood and Bone", ReviewType="Analysis", CategoryId=4, MainPage=true, Picture="nile.jpg" , UploadDate=DateTime.Now.AddDays(-2), Content="Having Sissy in Gradgrind's house worries Bounderby, who wants to marry teenage Louisa. He fears Sissy will corrupt Louisa, but he is mistaken. Sissy is kind and diligent, except when her father's disappearance overwhelms her. Then, she cannot help but cry. Noticing Sissy's tears one day, Louisa comforts her. Sissy and Louisa then become closer. While Sissy is often criticized at school for delighting in fancy rather than fact, Louisa has discovered she prefers imagination to reason. Nonetheless, when Bounderby, whom Louisa does not love, asks her to marry him, she agrees."},
				new ReviewsDB() { BookName="Carmilla" , Confirmation=true, BookSubject="Subject is Carmilla", AuthorName="Joseph Sheridan LeFanu", BookAnalysis="Informative", OtherBooks="The Game", ReviewType="General", CategoryId=4, MainPage=true, Picture="carmilla.jpg" , UploadDate=DateTime.Now.AddDays(-1), Content="I had to see this on the British Airways plane. It was terribly bad acting and a dumb story. Not even a kid would enjoy this. Something to switch off if possible."},
				new ReviewsDB() { BookName="Kidnapped" , Confirmation=true, BookSubject="Subject is Kidnapping", AuthorName="Robert Louis Stevenson", BookAnalysis="Intriguing", OtherBooks="Ten Tales from the Decameron", ReviewType="General", CategoryId=5, MainPage=true, Picture="kidnapped.jpg" , UploadDate=DateTime.Now.AddDays(-4), Content="The English translation of the title on the DVD version of this film is Graveyard of Horrors, but I think that must be an error. It should have been called Graveyard of Horribles. Horrible acting, horrible editing, horrible story, and horrible music all make this a horrible film best left in a horrible graveyard. Horrible."}
			};

			foreach (ReviewsDB item in reviews)
			{
